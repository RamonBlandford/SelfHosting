  ...
  <div class="redshoes-main">
    <header class="redshoes-header">
      <h1 class="redshoes-title">
        Contact Red Shoes Technology
      </h1>
      <p class="redshoes-subtitle">
        Reach out for project enquiries, support, or partnership opportunities.
      </p>
    </header>
    ...
    <section class="redshoes-section contact-section">
      ...
      <div class="redshoes-tile business-info-tile">
        ...
        <p class="redshoes-tile-desc contact-info">
          <b>Email:</b> <a href="mailto:info@redshoestechnology.com.au">info@redshoestechnology.com.au</a>
        </p>
        <p class="redshoes-tile-desc contact-info">
          <b>Phone:</b> <a href="tel:0433265783">0433 265 783</a>
        </p>
        <p class="redshoes-tile-desc contact-info">
          <b>Mail:</b> PO Box 1138, St Kilda South VIC 3182
        </p>
        <br>
        <a href="https://www.linkedin.com/company/red-shoes-technology/" target="_blank" rel="noopener">
        ...
        <p class="redshoes-tile-desc">
          <b>©2025 by Red Shoes Technology.</b><br>
