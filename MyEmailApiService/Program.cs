...
if( string.IsNullOrEmpty(builder.Configuration["AzureCommunication:EmailConnectionString"]))
    throw new InvalidOperationException("AzureCommunication:EmailConnectionString is not set in configuration.");
